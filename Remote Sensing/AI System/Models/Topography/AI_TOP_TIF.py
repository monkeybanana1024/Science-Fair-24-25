...
def main():
    ...
    for subdir in subdirs:
        aspect_path = os.path.join(root_dir, subdir, "normalized_topography.tif")
    ...
    log_dir = os.path.join("AI System/Topography/logs/", "AI_NORM_TIF-" + datetime.now().strftime("%Y%m%d-%H%M%S"))
