...
def main():
    ...
    model_path = "AI System/Results/Satellite/model.keras"
    ...
    make_predictions_and_save(model, X_test, output_file="AI System/Final Models/Convex/Satellite/results.csv")
