...
def main():
    ...
    # Ensure that the images have shape (47, 128, 128, 8)
    print(f"X_test shape before prediction: {images.shape}")
    assert images.shape == (47, 128, 128, 8), f"Shape mismatch: Expected (47, 128, 128, 8), got {images.shape}"
    ...
    make_predictions_and_save(model, X_test, output_file="AI System/Final Models/Slope/results.csv")
